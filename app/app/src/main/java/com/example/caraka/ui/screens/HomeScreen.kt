            ...
            item {
                Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    ...
                    Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(4.dp)) {
                        ...
                        ServiceTile(Icons.Default.Bolt, stringResource(R.string.service_label_simulator), MaterialTheme.colorScheme.primary, { onNavigateToProfile?.invoke() }, Modifier.weight(1f), R.drawable.ill_service_simulator)
                    }
                }
            }
