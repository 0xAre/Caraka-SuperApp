package com.example.garudamesh.data.local
...
import com.example.garudamesh.data.local.entity.RelayedMessageEntity
...
abstract class GarudaMeshDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile
        private var INSTANCE: GarudaMeshDatabase? = null

        fun getDatabase(context: Context): GarudaMeshDatabase {
            return INSTANCE ?: synchronized(this) {
                val instance = Room.databaseBuilder(
                    context.applicationContext,
                    GarudaMeshDatabase::class.java,
                    "garuda_mesh_db"
                )
